...
class StudentRepositoryTest {
    ...
    //@Disabled :끄기 or 주석 or Rollback
    //@BeforeEach //각각의 테스트 메서드 실행 직전에 수행되는 메서드 insertData, testFindByName, testFindByCityAndMajor 다 실행
    void insertData() {
    ...
    void testFindByName() {
        ...
        // when
        List<Student> students = studentRepository.findByName(name); //커스텀
    ...
    void testFindByCityAndMajor() {
        ...
        System.out.println("students(0) = " + students.get(0));
    }
    ...
    void testDeleteByJPQL() {
        ...
        assertEquals(0,students.size()); //지웠으므로 size 0
    }
}